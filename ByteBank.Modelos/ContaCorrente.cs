...
namespace ByteBank.Modelos
{
    ...
    public class ContaCorrente : IComparable
    {
        ...
        /// <summary>
        /// Realiza o saque e atualiza do valor da propriedade <see cref="Saldo"/>
        /// </summary>
        ...
        /// <param name="valor"> Representa o <see cref="valor"/> do saque, deve ser maior que 0 e menor que o <see cref="Saldo"/>. </param>
        ...
        public int CompareTo(object obj)
        {
            ...
            //Retornar zero quando a instância e o obj for igual
            //Retornar positivo diferente de 0 quando a precedência for de obj
